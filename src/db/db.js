  ...
  if (environment !== 'production') {
    ...
    if (parseInt(transactionCount.count) === 0) {
      ...
      const mockTransactions = [
        ...
        { title: 'Europe Fund Allocation', amount: 500.00, type: 'expense', date: new Date(Date.now() - 15 * 24 * 60 * 60 * 1000).toISOString(), category_id: getCatId('Investments'), latitude: baseLat + 0.002, longitude: baseLng - 0.002, location_name: 'Charles Schwab Digital Platform', notes: 'Monthly savings auto-transferred to Travel goals.', user_id: 1 },
        { title: 'Tesla Target Savings', amount: 1000.00, type: 'expense', date: new Date(Date.now() - 20 * 24 * 60 * 60 * 1000).toISOString(), category_id: getCatId('Investments'), latitude: baseLat + 0.002, longitude: baseLng - 0.002, location_name: 'Fidelity Brokerage Account', notes: 'Allocating index fund gains to Tesla deposit.', user_id: 1 },
        { title: 'Emergency Cache Deposit', amount: 800.00, type: 'expense', date: new Date(Date.now() - 22 * 24 * 60 * 60 * 1000).toISOString(), category_id: getCatId('Investments'), latitude: baseLat + 0.002, longitude: baseLng - 0.002, location_name: 'Ally High-Yield Savings Account', notes: 'Safety net growth addition.', user_id: 1 },
        { title: 'Europe Bonus Deposit', amount: 250.00, type: 'expense', date: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000).toISOString(), category_id: getCatId('Investments'), latitude: baseLat + 0.002, longitude: baseLng - 0.002, location_name: 'Charles Schwab Digital Platform', notes: 'Additional transfer for Europe fund.', user_id: 1 }
      ];
